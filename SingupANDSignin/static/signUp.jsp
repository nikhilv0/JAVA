...
<div class="container">
    <div class="form-container shadow-sm">
        ...
        <form action="signUp" method="post" onsubmit="return onValidate()">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="userId" name="userId" value="${dto.userId}" required/>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="confirmPassword" name="confirmPassword"
                       value="${dto.confirmPassword}" required/>
            </div>
            <div class="d-grid">
                <input type="submit" class="btn btn-black" value="signup" name="action"></input>
            </div>

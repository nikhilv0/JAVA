...
import com.xworkz.collection.dto.AeroplaneDTO;
...
//        BikeDTO bikeDto = new BikeDTO("Yamaha", "R15 V4", 155, 45.0, 140, "Petrol", "Blue");???
//        bikeDtos.add(bikeDto.getBrand());      ?????
        ...
        for (BikeDTO bike:bikeDtos){
            System.out.println(bike.getBrand()+bike.getModel()+bike.getEngineCapacity()+bike.getMileage()+bike.getTopSpeed()+bike.getFuelType()+bike.getColor());
            System.out.println("==========================================================================================================");
        }
        ...
        for (AeroplaneDTO aeroplaneDTO:aeroplaneDtos){

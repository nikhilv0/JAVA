...
import com.xworkz.inheritance.casting.*;
import com.xworkz.inheritance.casting.Object;
...
//        smartFitnessBand.purchase();
        ...
        actionHero.doStunts(karthikeyaGummakonda);
        ...
        System.out.println("_______________________________________________________________________________________");
        SundeepKishan sundeepKishan=new SundeepKishan();
        CoolPerformer coolPerformer=new CoolPerformer();
        coolPerformer.performCoolly(sundeepKishan);

        System.out.println("_______________________________________________________________________________________");
        Button button=new Button();
        CustomButton customButton=new CustomButton();
        customButton.press(button);
        ...
        System.out.println("_______________________________________________________________________________________");
        Sanjana sanjana=new Sanjana();
        GlamQueen glamQueen=new GlamQueen();
        glamQueen.dazzleScreen(sanjana);
        ...
        Nagarjuna nagarjuna=new Nagarjuna();
        King king=new King();
        king.ruleScene(nagarjuna);

        System.out.println("_______________________________________________________________________________________");
        Balakrishna balakrishna=new Balakrishna();
        Legend legend=new Legend();
        legend.dominateScreen(balakrishna);

        System.out.println("_______________________________________________________________________________________");
        Nithiin nithiin=new Nithiin();
        LoverBoy loverBoy=new LoverBoy();
        loverBoy.romance(nithiin);

        System.out.println("_______________________________________________________________________________________");
        RaviTeja raviTeja=new RaviTeja();
        MassMaharaja massMaharaja=new MassMaharaja();
        massMaharaja.entertainMass(raviTeja);

        System.out.println("_______________________________________________________________________________________");
        VarunTej varunTej=new VarunTej();
        MegaPrince megaPrince=new MegaPrince();
        megaPrince.risePowerfully(varunTej);

        System.out.println("_______________________________________________________________________________________");
        RamCharan ramCharan=new RamCharan();
        MegaSon megaSon=new MegaSon();
        megaSon.megaStrike(ramCharan);

        System.out.println("_______________________________________________________________________________________");
        Chiranjeevi chiranjeevi=new Chiranjeevi();
        Megastar megastar=new Megastar();
        megastar.leadMovie(chiranjeevi);

        System.out.println("_______________________________________________________________________________________");
        Nani nani=new Nani();
        NaturalStar naturalStar=new NaturalStar();
        naturalStar.actNaturally(nani);
        ...
        power.powerMove(pawanKalyan);

        System.out.println("_______________________________________________________________________________________");
        MaheshBabu maheshBabu=new MaheshBabu();
        Prince prince=new Prince();
        prince.charmAudience(maheshBabu);

        System.out.println("_______________________________________________________________________________________");
        Prabhas prabhas=new Prabhas();
        Rebel rebel=new Rebel();
        rebel.rebelRole(prabhas);
        ...
        System.out.println("_______________________________________________________________________________________");
        AkhilAkkineni akhilAkkineni=new AkhilAkkineni();
        RisingStar risingStar=new RisingStar();
        risingStar.shine(akhilAkkineni);

        System.out.println("_______________________________________________________________________________________");
        Sharwanand sharwanand=new Sharwanand();
        RomanticHero romanticHero=new RomanticHero();
        romanticHero.expressLove(sharwanand);

        System.out.println("_______________________________________________________________________________________");
        VijayDeverakonda vijayDeverakonda=new VijayDeverakonda();
        Rowdy rowdy=new Rowdy();
        rowdy.breakRules(vijayDeverakonda);

        System.out.println("_______________________________________________________________________________________");
        Network network=new Network();
        Server server=new Server();
        server.sevrice(network);

        System.out.println("_______________________________________________________________________________________");
        AlluArjun alluArjun=new AlluArjun();
        StylishStar stylishStar=new StylishStar();
        stylishStar.danceStyle(alluArjun);

        System.out.println("_______________________________________________________________________________________");
        SaiDharamTej saiDharamTej=new SaiDharamTej();
        SupermeHero supermeHero=new SupermeHero();
        supermeHero.showSupremacy(saiDharamTej);
        ...
        System.out.println("_______________________________________________________________________________________");
        Shashank shashank=new Shashank();
        Versatile versatile=new Versatile();
        versatile.adaptRole(shashank);

        System.out.println("_______________________________________________________________________________________");
        Venkatesh venkatesh=new Venkatesh();
        VictoryVenkatesh victoryVenkatesh=new VictoryVenkatesh();
        victoryVenkatesh.celebrateVictory(venkatesh);

        System.out.println("_______________________________________________________________________________________");
        Aryan aryan=new Aryan();
        YoungTalent youngTalent=new YoungTalent();
        youngTalent.debut(aryan);

        System.out.println("_______________________________________________________________________________________");
        JrNTR jrNTR=new JrNTR();
        YoungTiger youngTiger=new YoungTiger();
        youngTiger.roar(jrNTR);

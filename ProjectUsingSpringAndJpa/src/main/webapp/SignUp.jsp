    ...
    <div class="card shadow-lg p-4 rounded-4" style="max-width: 500px; width: 100%;">
        ...
        <form id="signUpForm" action="signUp" method="post" novalidate>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name="fullName" value="${signUpDTO.fullName}"
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" name="email" value="${signUpDTO.email}"
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="phone" name="phone" value="${signUpDTO.phone}"
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="age" name="age" value="${signUpDTO.age}"
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="password" name="password" value="${signUpDTO.password}"
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="confirmPassword" name="confirmPassword"
                       value="${signUpDTO.confirmPassword}" placeholder="Confirm password" required>
